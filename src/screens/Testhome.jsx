...
<img src={faceOne} alt="" className='w-1/5 rounded-full border-solid border-4 border-sky-500 show'/>
<img src={faceTwo} alt="" className='w-1/5  rounded-full ml-[-1rem] border-4 border-sky-500 show'/>
<img src={faceThree} alt="" className='w-1/5   rounded-full ml-[-1rem] border-4 border-sky-500 show'/>
<img src={faceFour} alt="" className='w-1/5  rounded-full ml-[-1rem] border-4 border-sky-500 none'/>
<img src={faceFive} alt="" className='w-1/5  rounded-full ml-[-1rem] border-4 border-sky-500 none'/>
...
<div className='w-full h-[1650px] bg-slate-100 '>
  ...
  <div className=' headtext'>
    <h2 className='font-sans text-3xl txt text-[#694b94] straight'>Therapy when you need it</h2>
    <p className='font-sans text-xl txt text-[#694b94]'>You can message your therapist at anytime, from anywhere. You also get to schedule live sessions when it's convenient for you, and can connect from any mobile device or computer.</p>
  </div>
  </div>
  </div>
